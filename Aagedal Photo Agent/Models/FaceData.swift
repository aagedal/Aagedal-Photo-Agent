...
nonisolated struct DetectedFace: Codable, Identifiable {
    ...
    /// Exact model/preprocessing identity captured with freshly generated bytes.
    /// Cached records written before provenance existed decode as nil and stay unknown.
    let embeddingProvenance: FaceEmbeddingProvenance?
    ...
    init(
        ...
        embeddingProvenance: FaceEmbeddingProvenance? = nil,
        groupID: UUID? = nil,
        detectedAt: Date,
        ...
        self.embeddingProvenance = embeddingProvenance
