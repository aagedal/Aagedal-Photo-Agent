...
2. Close journalistic workflow release hardening. Caption Workspace, Batch Rename, Deadline Mode,
   ...
   compatible transcript-variable application and verified WAV delivery, plus broader real-sample compatibility,
