...
2. Close journalistic workflow release hardening. Caption Workspace, Batch Rename, Deadline Mode,
   ...
   voice-memo lifecycle/reviewed-transcript/variable/delivery integration beyond the implemented
   ILCE-1 v4.00 ingest, persisted relationships, rename, Duplicate, playback and local editable-draft foundation, plus broader real-sample compatibility,
