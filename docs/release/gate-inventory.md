...
**Current status:** Import and rename foundations now also include production Duplicate, independently copied shared memos, hash/record stability checks and rollback. General Move and Reject are added in [cycle 2](cycle-02-memo-moves-toolbar-2026-09-09.md). [Cycle 3](cycle-03-memo-trash-2026-09-10.md) adds recoverable memo Trash and sibling metadata preservation. [Cycle 20](cycle-20-voice-memo-raw-archive-2026-09-12.md) adds the shared JPEG XL/TIFF/DNG archive transaction. [Cycle 21](cycle-21-voice-memo-recovery-2026-09-13.md) adds schema-2 photo/WAV identities and verified Caption recovery of a missing adjacent memo. [Cycle 22](cycle-22-voice-memo-reassociation-2026-09-13.md) adds user-scoped exact moved-relationship discovery and transactional reassociation with explicit duplicate, changed and missing results. Authentic-media/native picker, archive and physical-volume evidence remain incomplete.

**Smallest next action/evidence:** Exercise cycle 22 through the native picker on authorized Sony material, including exact, duplicate, changed, missing, collision, relaunch, accessibility and disappearing-source cases; then exercise real RAW, DNG Converter, C2PA and physical-volume archive/recovery. Preserve explicit shared/missing states and rollback. Real-sample end-to-end validation remains.
