...
**Next implementation slice after cycle 87:** Connect local exact-plan consent to a retained
...
Cycle 87 supplies all-field effective semantic expectations; physical-carrier preservation is still unverified. Status/cancellation-request endpoints expose coordination records only. Deterministic expiry/
