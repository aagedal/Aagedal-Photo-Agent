...
**Updated:** 2026-09-21
**Latest implementation state:** [Cycle 86](cycle-86-bundled-whisper-downloads-2026-09-21.md) passes 3,230 tests / 338 suites in 127.497 seconds, repository validation and the live rebuilt MCP helper probe. It adds embedded patched FFmpeg, explicit size/SHA-256-verified model downloads in Settings → Transcription, and managed Whisper provider discovery. Artifact checks pass nine image comparisons, six CPU process scenarios, eight bundled-component validator tests and the canonical output sanitizer harness. Signed-app runtime admission and download/setup lifecycle regression pass. Native verification and the current cycle commit are recorded by the coordinator. Production MCP executors, guarded IPTC commits, complete source-companion distribution, signed model lifecycle and final offline/GPU acceptance remain open.
**Latest native evidence:** Cycle 86 passes three native workflows in 101.506 seconds, verifying managed model setup stays in Settings, no download starts on opening/reopening, Caption stays clean, and custom setup/options retain their behavior without changing photo, memo or transcript fixture bytes.
**Cycle baseline:** `ca9602b`, initially clean. No broad release-readiness gate is newly closed.
