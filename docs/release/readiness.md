...
**Updated:** 2026-09-15
**Latest implementation state:** Cycle 47 retains and rechecks the authorized-root and nested-directory path chain before publishing combined revision/draft evidence. Its focused 21-test and final-source complete 3,780-execution serial suites pass with zero failures/skips; repository validation passes. Cycle 46 rechecked all source, XMP and current/legacy app-JSON entries; cycles 44–45 added bounded unreconciled draft fields and stable individual reads. Cycles 34–43 established bundled default-off transport, client setup, shared reservations, discovery and root-anchored evidence. Effective typed metadata reads, production workflow tools, broader operation coordination, FFmpeg Whisper, independent review and native-client evidence remain open. Cycle 31's 10-test pass remains the latest complete UI-smoke-target result because later whole-target attempts encountered desktop/menu focus instability.
...
**Cycle baseline:** `d75fbe7` on `main` for cycle 47; cycles 16–33 advance Known People and Sony voice-memo workflows, cycles 34–40 establish MCP transport, authority, reservations and discovery, cycles 41–43 add anchored revision/draft-state reads, cycle 44 exposes bounded app-owned descriptive draft fields, cycle 45 tightens carrier stability and STDIO bounds, cycle 46 refuses mixed-generation carriers, and cycle 47 rechecks retained ancestor identity at publication.
