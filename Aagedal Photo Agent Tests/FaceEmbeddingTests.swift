...
struct FaceEmbeddingTests {
    ...
    @Test func currentInterchangeProvenanceIsExactAndLegacyRecordsRemainUnknown() throws {
        let current = FaceEmbeddingProvenance.current
        #expect(current.embeddingSpaceVersion == 3)
        #expect(current.componentID == "auraface-r100-coreml")
        #expect(current.modelID == "AuraFace-v1/glintr100")
        #expect(current.preprocessingRevision == "photo-agent-eyes112-rgb-v3")
        #expect(current.vectorEncoding == "fem2-float32-le")
        #expect(current.dimension == 512)
        #expect(current.l2Normalized)
        #expect(current.isCurrentInterchangeCompatible)

        var vector = [Float](repeating: 0, count: 512)
        vector[0] = 1
        let original = PersonEmbedding(
            featurePrintData: try FaceEmbeddingInterchangeCodec.encode(vector),
            sourceDescription: "source.nef",
            recognitionMode: .faceAndClothing,
            provenance: current
        )
        ...
        #expect(roundTrip.provenance == current)

        let legacyJSON = """
        {
          "id":"00000000-0000-0000-0000-000000000001",
          "featurePrintData":"",
          "addedAt":0
        }
        """.data(using: .utf8)!
        let legacy = try JSONDecoder().decode(PersonEmbedding.self, from: legacyJSON)
    ...
    @Test func knownPeopleAdditionCopiesOnlyDetectedFaceProvenance() throws {
        ...
        let cachedLegacyFace = DetectedFace(
            id: UUID(),
            imageURL: URL(fileURLWithPath: "/fixtures/legacy.nef"),
            faceRect: .zero,
            featurePrintData: bytes,
            detectedAt: date,
            embeddingMode: .visionFeaturePrint
        )
        let legacySample = PersonEmbedding(detectedFace: cachedLegacyFace, addedAt: date)
        #expect(legacySample.provenance == nil)

        let freshFace = DetectedFace(
            id: UUID(),
            imageURL: URL(fileURLWithPath: "/fixtures/fresh.nef"),
            faceRect: .zero,
            featurePrintData: bytes,
            embeddingProvenance: .current,
            detectedAt: date,
            embeddingMode: .faceAndClothing
        )
        let freshSample = PersonEmbedding(detectedFace: freshFace, addedAt: date)
        #expect(freshSample.provenance == .current)
        #expect(freshSample.featurePrintData == bytes)
        #expect(freshSample.sourceDescription == "fresh.nef")
        #expect(freshSample.addedAt == date)
        #expect(freshSample.recognitionMode == .faceAndClothing)

        let decodedCached = try JSONDecoder().decode(
            DetectedFace.self,
            from: JSONEncoder().encode(cachedLegacyFace)
        )
        #expect(decodedCached.embeddingProvenance == nil)
